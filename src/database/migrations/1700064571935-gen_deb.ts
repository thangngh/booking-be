...
export class GenDeb1700064571935 implements MigrationInterface {
    name = 'GenDeb1700064571935'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_99aa095bfe87979846a3374518\` ON \`doctor_register\``);
        await queryRunner.query(`ALTER TABLE \`conversation\` CHANGE \` user_id\` \`user_id\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`message\` ADD CONSTRAINT \`FK_7cf4a4df1f2627f72bf6231635f\` FOREIGN KEY (\`conversationId\`) REFERENCES \`conversation\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`conversation\` CHANGE \`user_id\` \` user_id\` varchar(255) NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_99aa095bfe87979846a3374518\` ON \`doctor_register\` (\`user_id\`)`);
    }
